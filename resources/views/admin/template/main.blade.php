                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu" >
                            <div class="menu_section">
                                <ul class="nav side-menu" >
                                    ...
                                    <li><a href="{{url('cabecera')}}"><i class="fa fa-gg"></i>Cabecera</a></li>
                                    <li><a href="{{url('detalle')}}"><i class="fa fa-tasks"></i>Detalle </a></li>
                                    <li><a href="{{url('caja')}}"><i class="fa fa-calculator"></i>Caja</a></li>
                                    <li><a href="{{url('cliente')}}"><i class="fa fa-bars"></i>Clientes</a></li>
                                    <li><a href="{{url('tipocliente')}}"><i class="fa fa-users"></i> Tipo Clientes</a></li>
                                    <li><a href="{{url('empleado')}}"><i class="fa fa-users"></i> Empleados</a></li>
                                    <li><a href="{{url('facturaspendientes')}}"><i class="fa fa-columns"></i> Facturas P
                                    endientes</a></li>
