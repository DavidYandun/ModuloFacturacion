...
@section('contenido')
        <div class="container">
            <div class="container " <thead style="background: #e8edff; color:#339;">
            ...
            <div class="col-lg-3" >
                <label><h4> FACTURA N°000&nbsp;{{$cabecera->idcabecera}}</h4></label>
            </div>
            </div>
...
<div class="panel-body">
    <div class="table-responsive">
     ...
     <table class="table table-striped table-bordered table-condensed table-hover">
                                <thead style="background: #e8edff; color: #339;">
                                    <th>Cantidad</th>
                        ...
                        <tr>
                            ...
                            <td align="right">{{$det->valor_total}}</td>
                                ...
                                @endforeach
                                    ...
                                    <a class="btn btn-primary" href="{{URL::action('CabeceraController@ExportPDF',$cabecera->idcabecera)}}"><i class="glyphicon glyphicon-print">IMPRIMIR</i></a>                                                                                              
