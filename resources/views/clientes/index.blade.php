...
<!--<div class="container">
    ...
    <div>
        <!--<a class="btn btn-primary" href="{{url('cliente/create')}}"><i class="glyphicon glyphicon-user"> Nuevo</i></a>-->
        <button class="btn btn-primary" data-toggle="modal" data-target="#nuevo"><i class="glyphicon glyphicon-user"> Nuevo</i></button>
    </div>
    <div class="row">
        <div class="col-md-12">
